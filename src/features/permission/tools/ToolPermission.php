...
namespace YiiHelper\features\permission\tools;
 ...
 * @package YiiHelper\features\permission\tools
 */
class ToolPermission
{
    use TLoginRequired;
    ...
    {
        // 公共的api后端路径
        $paths = Instance::modelPermissionApi()::getPublicApi(true, 1);
        // 公共的菜单
        $menus = Instance::modelPermissionMenu()::getPublicApi(true, 1);
        return [
            'roles' => [],
            'menus' => $menus,
            'paths' => $paths,
