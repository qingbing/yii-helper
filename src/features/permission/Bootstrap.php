...
namespace YiiHelper\features\permission;
 ...
 * @package YiiHelper\features\permission
 */
class Bootstrap implements BootstrapInterface
{
    ...
    public function bootstrap($app)
    {
        ...
        if (!$app->getUser()->getIsGuest()) {
            ...
            $paths = Instance::modelPermissionApi()::getPublicApi();
        }
     ...
     * @return bool
     */
    protected function inWhiteIps()
    {
        $ip = Req::getUserIp();
        foreach ($this->whiteIps as $whileIp) {
            if (IpHelper::inRange($ip, $whileIp)) {
                return true;
            }
        }
        return false;
