...
class HeaderOptionService extends Service implements IHeaderOptionService
{
    ...
    {
        return HeaderOption::getOptionsByKey($params['header_key']);
    }
    ...
    {
        $models = HeaderOption::getOptionsByKey($params['header_key']);
        AppHelper::app()->getDb()->transaction(function () use ($models) {
            $sort_order = 1;
