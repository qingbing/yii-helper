...
class Interfaces extends Model
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'system_alias'       => '系统别名',
            'uri_path'           => '接口的path',
            'alias'              => '接口别名：systemAlias+uri_path',
            'name'               => '接口名称',
            'type'               => '接口类型[view:查看接口;operate:操作接口]',
            'description'        => '描述',
            'log_type'           => '日志记录方式[0:随系统; 1:强制开启；2:强制关闭]',
            'is_open_validate'   => '开启日志检查[0:未启用; 1:已启用]',
            'is_strict_validate' => '开启严格检查[0:未启用; 1:已启用],启用是每个字段都必须在{interface_fields}中定义',
            'created_at'         => '创建时间',
            'updated_at'         => '更新时间',
        ];
    }
